				...
				<div className="w-full max-w-md">
					...
					<div className="rounded-3xl border border-slate-200 bg-white/80 backdrop-blur-sm p-8 shadow-xl hover:shadow-2xl transition-all duration-300">
						...
						<p className="mb-6 text-center text-slate-600">
							Sign in to access your health screening dashboard
						</p>
						...
						{successMessage && (
							<div className="mb-4 rounded-lg border border-emerald-300 bg-emerald-50 px-4 py-3 text-sm text-emerald-700 font-medium">
								{successMessage}
							</div>
						)}
