  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900">
      ...
      <div className="container mx-auto px-4 md:px-6 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-neutral-900 space-y-8 animate-fade-in">
            ...
            {/* Subheading */}
            <p className="text-lg md:text-xl text-neutral-900 leading-relaxed max-w-2xl">
            ...
            <div className="grid grid-cols-3 gap-4 py-4">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-neutral-900 mt-1">Women Anemic<br/>in Assam</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-accent-300">₹0</div>
                <div className="text-xs md:text-sm text-neutral-900 mt-1">Cost Per<br/>Screening</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-neutral-900">5 min</div>
                <div className="text-xs md:text-sm text-neutral-900 mt-1">Assessment<br/>Time</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a 
                href="#how-it-works" 
                className="bg-white/10 backdrop-blur-sm text-neutral-900 px-8 py-4 rounded-lg font-bold text-lg border-2 border-white/30 hover:bg-white/20 transition-all duration-200 text-center"
              >
                Watch How It Works
              </a>
            </div>
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap items-center gap-6 pt-4 text-sm text-neutral-900">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a href="#problem" className="text-white flex flex-col items-center space-y-2">
